        ...
        >
          ...
          <div className="flex flex-col gap-8 md:hidden">
            ...
            <motion.div className="flex flex-wrap gap-3" variants={fadeUp}>
              <a href="/Ayush_Raj_Resume.pdf" download="Ayush_Raj_Resume.pdf" className="flex items-center gap-2 px-5 py-2.5 border-2 border-[#1b6a50] bg-[#1b6a50] rounded-[8px] font-sub uppercase text-[10px] tracking-[0.14em] font-medium text-white hover:bg-[#165740] hover:border-[#165740] transition-all duration-200">
                <Download size={14} />
                Resume
              </a>
