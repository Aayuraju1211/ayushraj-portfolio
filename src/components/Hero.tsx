        ...
        >
          ...
          <div className="hidden md:grid md:grid-cols-[1fr_auto] gap-16 items-center w-full">
            ...
            <motion.div className="flex flex-col gap-10 pt-16" variants={fadeUp}>
              ...
              <a
                  ...
                  className="flex items-center gap-2.5 px-6 py-3 border-2 border-[#1b6a50] bg-transparent font-sub uppercase text-[11px] tracking-[0.14em] font-medium text-white hover:bg-[#1b6a50] transition-all duration-200"
                >
                  <Download size={15} />
                  Download Resume
                </a>
          ...
          <div className="flex flex-col gap-8 md:hidden">
            ...
            <motion.div className="flex flex-wrap gap-3" variants={fadeUp}>
              <a href="/Ayush_Raj_Resume.pdf" download="Ayush_Raj_Resume.pdf" className="flex items-center gap-2 px-5 py-2.5 border-2 border-[#1b6a50] bg-transparent rounded-[8px] font-sub uppercase text-[10px] tracking-[0.14em] font-medium text-white hover:bg-[#1b6a50] transition-all duration-200">
                <Download size={14} />
                Resume
              </a>
